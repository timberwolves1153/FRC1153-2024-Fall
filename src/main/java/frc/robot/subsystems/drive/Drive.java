...
// Current constants are place holders 
  ...
  public void periodic() {
    ...
    for (int i = 0; i < sampleCount; i++) {
      ...
      Logger.recordOutput("FPGATimestamp", Timer.getFPGATimestamp());
        ...
        Logger.recordOutput("GetGyroAngle", rawGyroRotation);
...
public void setVisionMeasurementStdDevs(Matrix<N3, N1> stds) {
  poseEstimator.setVisionMeasurementStdDevs(stds);
}
...
public void zeroAngle() {
  ...
  Rotation2d.fromRadians(AprilTags.TAU/2));
}
